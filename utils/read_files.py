...
#Content reading function for t3
...
#Content reading function for t23
...
#Content reading function for t4
...
def read_files_for_rain_days():
    dir_path = os.path.dirname(os.path.realpath("weather_task.weatherfiles/"))
    weatherfiles_path = os.path.join(dir_path, '..', 'weatherfiles')
